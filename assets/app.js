...
function importData(file) {
  ...
  // заменял текущие данные более старыми, а следующий автосинк разъезжался
  // со снимком синка и разослал бы «удаление» на всё, чего в старом файле нет.
  if (!confirm("Заменить текущие данные содержимым файла? Несохранённые правки будут потеряны.")) return;
