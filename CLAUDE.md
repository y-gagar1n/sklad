...
- Device-local, **не синкается**: `activeFloorId`, свёрнутые категории, конфиг
  синка (адрес/токен), локальный журнал операций синка (`assets/oplog.js`,
  ключ `sklad-oplog-v1`, кольцевой буфер до 200 КБ — для расследования; кнопка
  «Отправить логи» шлёт его на `POST /client-logs`, отдельно от самих данных
  склада).
